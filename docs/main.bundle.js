...
/***/ "../../../../../../dist/drag-drop-list.directive.js":
...
var DragDropListDirective = (function () {
    ...
    DragDropListDirective.prototype.keyup = function ($event) {
        switch ($event.which) {
            case 16:
                this.shiftDown = false;
                this.removeDraggedStyle();
    ...
    DragDropListDirective.prototype.keydown = function ($event) {
        switch ($event.which) {
            case 38:
                this.keydownDown();
                break;
    ...
    DragDropListDirective.prototype.keydownDown = function () {
        if (this.shiftDown) {
            this.switchPrev();
        }
        else {
    ...
    DragDropListDirective.prototype.keydownUp = function () {
        if (this.shiftDown) {
            this.switchNext();
        }
        else {
    ...
    DragDropListDirective.prototype.switchNext = function () {
        var _this = this;
        var dropIndex = this.dragDropList[0];
        var array = this.dragDropList[1];
        var swapIndex, temp;
    ...
    DragDropListDirective.prototype.switchPrev = function () {
        var _this = this;
        var dropIndex = this.dragDropList[0];
        var array = this.dragDropList[1];
        var swapIndex, temp;
    ...
    DragDropListDirective.prototype.focusNext = function () {
    ...
    DragDropListDirective.prototype.focusPrev = function () {
        var elem = this.el.nativeElement;
        var brothers = elem.parentElement.children;
        var array = [].slice.call(brothers);
        var myIndex = array.indexOf(this.el.nativeElement);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__("../../../../../../node_modules/@angular/core/esm5/core.js");
var drag_drop_list_directive_1 = __webpack_require__("../../../../../../dist/drag-drop-list.directive.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ng_drag_drop_list_dist_drag_drop_list_module__ = __webpack_require__("../../../../../../dist/drag-drop-list.module.js");
